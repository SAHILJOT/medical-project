...
<body>
	<form action="DisImg" method="post">
    ...
    <button class="btn" onclick="window.location.href='./login.html'">go to login page</button><br>
    <button class="btn" onclick="window.location.href='./SignUp.html'">Create new Account</button><br>
